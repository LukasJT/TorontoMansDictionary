...
PAGES = [
    ...
    {
        "slug": "toronto-arenas-1917",
        "title": "The Toronto Arenas: The NHL's First Toronto Champions",
        "kicker": "A hastily assembled club won the Stanley Cup in its very first season",
        "h1": "The Toronto Arenas",
        "dek": "The NHL was founded in 1917 partly to freeze out a Toronto owner — and the improvised replacement team it created won the Stanley Cup anyway, in a franchise line that runs unbroken to today's Maple Leafs.",
        "meta_desc": "The history of the Toronto Arenas, the NHL's first Toronto franchise: the league's 1917 founding, the Arenas' 1918 Stanley Cup win, and the path to the Toronto Maple Leafs.",
        "keywords": "Toronto Arenas history, NHL founding 1917, 1918 Stanley Cup Toronto",
        "hero_img": "Toronto_skyline_(2012).jpg",
        "hero_alt": "The Toronto skyline",
        "hero_credit": "Toronto skyline — Wikimedia Commons, CC BY 2.0",
        "sections": [
            (None, '<p>On November 26, 1917, representatives of several hockey clubs met at Montreal\'s Windsor Hotel and voted to suspend the National Hockey Association, forming the National Hockey League in its place — a maneuver widely understood as a way to freeze out Toronto Blueshirts owner Eddie Livingstone, with whom the other owners had an ongoing dispute.</p>'),
            ("An improvised club wins the Cup", '<p>A new, "temporary" Toronto club was organized by the Arena Company under order of the NHL\'s first president, Frank Calder, using the roster of the old Blueshirts. This club, retroactively known as the Toronto Arenas, played its inaugural NHL season, 1917–18, out of the Arena Gardens on Mutual Street — and won the Stanley Cup that same season, defeating the Vancouver Millionaires three games to two. It was the first major professional sports championship won by a Toronto team.</p>'),
            ("From Arenas to St. Patricks to Maple Leafs", '<p>Financial struggles plagued the Arena Company, and the club was renamed the Toronto St. Patricks after the 1918–19 season. The St. Pats played under that name until 1927, when a syndicate led by <a href="conn-smythe.html">Conn Smythe</a> purchased the team and renamed it the Toronto Maple Leafs — the identity that persists today, tracing an unbroken franchise line back to that improvised 1917 club.</p>'),
        ],
        "sources": [
            ("NHL.com — This Date in NHL History: NHL Founded in 1917", "https://www.nhl.com/news/this-date-in-nhl-history-november-26-284067462"),
            ("NHL.com — Arenas Gave Toronto 1st Stanley Cup Championship 106 Years Ago", "https://www.nhl.com/news/arenas-gave-toronto-1st-stanley-cup-championship-in-1918"),
        ],
        "related_words": [],
    },
    {
        "slug": "conn-smythe",
        "title": "Conn Smythe: The Man Who Built the Maple Leafs",
        "kicker": "Fired by the Rangers, so he built a rival at home instead",
        "h1": "Conn Smythe",
        "dek": "After being fired by the expansion New York Rangers in 1926, Toronto-born Conn Smythe bought a bankrupt local team, renamed it the Maple Leafs, and ran it for 34 years — building Maple Leaf Gardens along the way.",
        "meta_desc": "The history of Conn Smythe, the Toronto Maple Leafs' longtime owner and general manager: his 1927 purchase of the team, seven Stanley Cups, and the building of Maple Leaf Gardens.",
        "keywords": "Conn Smythe history, Maple Leafs founder, Conn Smythe Trophy",
        "hero_img": "Conn_Smythe_Trophy_2010-04-03.JPG",
        "hero_alt": "The Conn Smythe Trophy, awarded annually to the Stanley Cup playoffs' most valuable player",
        "hero_credit": "Conn Smythe Trophy — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>Constantine Falkland Cary "Conn" Smythe was born in Toronto in 1895. He served in WWI artillery and air units, was taken prisoner, and later earned an engineering degree from the University of Toronto in 1920, where he had also played and coached hockey. In 1926 he was hired to assemble the roster for the expansion New York Rangers but was fired by management before the season began — a slight that fueled his drive to build a rival power in his home city.</p>'),
            ("Building the Maple Leafs", '<p>In 1927, with the <a href="toronto-arenas-1917.html">Toronto St. Patricks</a> facing financial collapse and a real threat of relocation, Smythe organized a syndicate to buy the club, rename it the Toronto Maple Leafs, and change its colours from green-and-white to blue-and-white. He served as the team\'s principal owner, general manager and de facto architect of its culture from 1927 to 1961. Under his stewardship the Leafs won seven Stanley Cups.</p>'),
            ("Maple Leaf Gardens and legacy", '<p>Even during the Great Depression, Smythe led the financing and construction of <a href="maple-leaf-gardens.html">Maple Leaf Gardens</a>, opened in 1931, and pioneered coast-to-coast radio broadcasts of Leafs games via Foster Hewitt. In 1964, Maple Leaf Gardens Ltd. created the Conn Smythe Trophy, awarded annually to the most valuable player of the Stanley Cup playoffs. Smythe was inducted into the Hockey Hall of Fame as a "builder."</p>'),
        ],
        "sources": [
            ("Britannica — Conn Smythe", "https://www.britannica.com/biography/Conn-Smythe"),
            ("Ontario Sports Hall of Fame — Conn Smythe", "https://ontariosportshalloffame.com/inductees/sports-specialties/hockey/conn-smythe/"),
        ],
        "related_words": [],
    },
    {
        "slug": "maple-leaf-gardens",
        "title": "Maple Leaf Gardens: Built in Five Months, During the Depression",
        "kicker": "The 'Cathedral of Hockey,' now a grocery store and university arena",
        "h1": "Maple Leaf Gardens",
        "dek": "Construction began June 1, 1931; the arena opened five months later. It hosted the Leafs for 68 years, the Beatles twice, and now houses a Loblaws under the same roof as a university hockey rink.",
        "meta_desc": "The history of Maple Leaf Gardens: its five-month 1931 construction, its 68 years as the Maple Leafs' home arena, and its adaptive reuse as a Loblaws and TMU athletic centre.",
        "keywords": "Maple Leaf Gardens history, Mattamy Athletic Centre, Maple Leaf Gardens Loblaws",
        "hero_img": "Maple_Leaf_Gardens_-_50_Carlton_Street,_Toronto,_ON_M5B_1J2,_Canada.jpg",
        "hero_alt": "Exterior of Maple Leaf Gardens at Carlton and Church Streets, Toronto",
        "hero_credit": "Maple Leaf Gardens, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p><a href="conn-smythe.html">Conn Smythe</a> led the financing and construction of Maple Leaf Gardens at the northwest corner of Carlton and Church Streets. Remarkably, construction began June 1, 1931, and the building opened just over five months later, on November 12, 1931, at a cost of roughly $1.5 million, built largely with unionized labour that in some cases accepted stock in lieu of full wages during the Depression. It quickly earned the nickname "the Cathedral of Hockey."</p>'),
            ("68 years as the Leafs\' home", '<p>Maple Leaf Gardens served as the Toronto Maple Leafs\' home arena for 68 years, hosting Stanley Cup championships and the first nationally broadcast NHL radio broadcasts via Foster Hewitt. Beyond hockey, it hosted boxing, concerts — the Beatles played there in 1964 and 1965 — and other major public events. The Leafs played their final regular-season game at the Gardens in February 1999 before moving to the new Air Canada Centre, now Scotiabank Arena.</p>'),
            ("A grocery store and a university rink", '<p>After sitting partly dormant, the building\'s future was secured through a 2004 purchase agreement between Loblaw Companies and Maple Leaf Sports & Entertainment, followed by a 2009 partnership investing about $60 million in redevelopment. The lower level reopened as a flagship <a href="loblaws-history.html">Loblaws</a> grocery store in 2010, while the upper level reopened in 2012 as the Mattamy Athletic Centre, home to Toronto Metropolitan University\'s varsity hockey and basketball — preserving the arena\'s bowl inside a modern retail and athletic hybrid.</p>'),
        ],
        "sources": [
            ("ERA Architects — Maple Leaf Gardens", "https://www.eraarch.ca/projects/maple-leaf-gardens/"),
            ("Mattamy Athletic Centre — History of Maple Leaf Gardens", "https://www.mattamyathleticcentre.ca/venue-info/arena-highlights-history"),
        ],
        "related_words": [],
    },
    {
        "slug": "toronto-fc-founding",
        "title": "Toronto FC: MLS's First Team Outside the U.S.",
        "kicker": "A stadium built specifically to give Toronto a soccer-first home",
        "h1": "Toronto FC",
        "dek": "When MLS awarded Toronto an expansion franchise in 2005, the league had never had a team outside the United States. BMO Field was purpose-built to give it one.",
        "meta_desc": "The history of Toronto FC: MLS's first Canadian franchise, its 2007 founding, and the construction of BMO Field as the country's first soccer-specific major stadium.",
        "keywords": "Toronto FC founding, MLS first Canadian team, BMO Field history",
        "hero_img": "BMO_Field,_Toronto,_Ontario_(29969149766).jpg",
        "hero_alt": "BMO Field at Exhibition Place, Toronto",
        "hero_credit": "BMO Field, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>Major League Soccer awarded an expansion franchise to Maple Leaf Sports & Entertainment in 2005, for a reported $10 million expansion fee, making it MLS\'s first team based outside the United States. The club name, Toronto FC, was unveiled in May 2006, following a public naming consultation that favoured a simple, direct civic identity over a more "branded" mascot-style name.</p>'),
            ("A stadium built for it", '<p>Toronto FC formally launched as an MLS expansion side for the 2007 season, playing out of the newly built <a href="exhibition-place.html">BMO Field</a> at Exhibition Place, a stadium constructed specifically to give the club a soccer-first home. The club\'s first home win came on May 12, 2007, when Danny Dichio scored the franchise\'s first-ever goal in a 3–1 victory over the Chicago Fire — a moment still commemorated by fans as one of the club\'s defining early images.</p>'),
            ("Building a Canadian soccer identity", '<p>The expansion team struggled on the field in its debut campaign, but sellout crowds and a vocal supporters\' culture immediately distinguished Toronto FC\'s atmosphere from much of the rest of the league. The club went on to win the Canadian Championship multiple times and became MLS Cup champion in 2017, the first Canadian club to do so — achievements resting on the foundation laid in 2007, when the club\'s arrival gave Canada standing as an MLS market.</p>'),
        ],
        "sources": [
            ("The Canadian Encyclopedia — Toronto FC", "https://www.thecanadianencyclopedia.ca/en/article/toronto-fc"),
        ],
        "related_words": [],
    },
    {
        "slug": "toronto-rock-lacrosse",
        "title": "The Toronto Rock: An Instant Champion",
        "kicker": "Won the league title in their very first Toronto season",
        "h1": "The Toronto Rock",
        "dek": "Relocated from Hamilton in 1999 and installed at Maple Leaf Gardens, the Toronto Rock won the National Lacrosse League championship in their first season in the city — and never really stopped winning.",
        "meta_desc": "The history of the Toronto Rock lacrosse team: its 1999 relocation from Hamilton, its first-season championship, and its record of seven National Lacrosse League titles.",
        "keywords": "Toronto Rock history, National Lacrosse League Toronto, box lacrosse Toronto",
        "hero_img": "Maple_Leaf_Gardens_-_50_Carlton_Street,_Toronto,_ON_M5B_1J2,_Canada.jpg",
        "hero_alt": "Exterior of Maple Leaf Gardens, the Toronto Rock's first home arena",
        "hero_credit": "Maple Leaf Gardens, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>The Toronto Rock\'s franchise history begins in 1998 as the Ontario Raiders, based in Hamilton — the first Canadian-based franchise in the National Lacrosse League. A group of investors purchased the franchise and relocated it to Toronto for the 1999 season, renaming it the Toronto Rock and installing it at <a href="maple-leaf-gardens.html">Maple Leaf Gardens</a>.</p>'),
            ("Instant success", '<p>The Rock made an immediate splash: in their first season in Toronto they won the NLL championship, defeating the Rochester Knighthawks 13–10 in the deciding game — played at Maple Leaf Gardens. Box lacrosse itself has deep Toronto-area roots as Canada\'s historic indoor summer game, giving the Rock\'s arrival a receptive, pre-existing local fan base rather than a cold start.</p>'),
            ("A decorated run", '<p>Over the following decades the Rock built one of the NLL\'s most decorated résumés, winning a total of seven league championships, tied for the most in NLL history. The team has played home games at Maple Leaf Gardens, Scotiabank Arena, and, from 2021 onward, at the Coca-Cola Coliseum — reflecting the same MLSE-adjacent arena ecosystem that has shaped much of Toronto\'s modern pro-sports landscape.</p>'),
        ],
        "sources": [
            ("Toronto Rock — About the Rock", "https://torontorock.com/about/"),
            ("NLL.com — NLL History", "https://www.nll.com/about/history/"),
        ],
        "related_words": [],
    },
    {
        "slug": "toronto-marlies",
        "title": "The Toronto Marlies: A Farm Team Named for a Century-Old Junior Club",
        "kicker": "Relocated to Toronto in 2005, named for a team Conn Smythe once owned",
        "h1": "The Toronto Marlies",
        "dek": "The Maple Leafs' AHL development team spent decades in New Brunswick, St. Catharines and Newfoundland before landing in Toronto — and taking its name from the storied junior club Conn Smythe bought in 1927.",
        "meta_desc": "The history of the Toronto Marlies: their franchise's journey from New Brunswick to Toronto in 2005, and the team's name tracing back to Conn Smythe's Toronto Marlboros.",
        "keywords": "Toronto Marlies history, Maple Leafs AHL affiliate, Toronto Marlboros",
        "hero_img": "Toronto_Marlies_faceoff.jpg",
        "hero_alt": "Toronto Marlies players at a faceoff",
        "hero_credit": "Toronto Marlies — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>The Marlies\' on-ice lineage stretches back to 1978, when the New Brunswick Hawks were founded as a farm club jointly operated by the Toronto Maple Leafs and Chicago Black Hawks. The franchise subsequently relocated several times: to St. Catharines, Ontario (1982–1986), Newmarket, Ontario (1986–1991), and St. John\'s, Newfoundland, where it played as the St. John\'s Maple Leafs from 1991 to 2005.</p>'),
            ("The move to Toronto", '<p>An opportunity opened when the Edmonton Oilers\' AHL affiliate relocated from Toronto to Edmonton in 2004, leaving the city-owned Ricoh Coliseum without a primary tenant. On July 1, 2005, Maple Leaf Sports & Entertainment leased the Coliseum and relocated its AHL farm club there, renaming the team the Toronto Marlies. The name is a direct callback to the Toronto Marlboros, a storied junior hockey club that <a href="conn-smythe.html">Conn Smythe</a> purchased as a Leafs-affiliated development pipeline after buying the NHL team in 1927.</p>'),
            ("A development pipeline", '<p>As the primary development affiliate of the Toronto Maple Leafs, the Marlies have served as the proving ground for many Leafs regulars over the past two decades, playing out of Coca-Cola Coliseum at Exhibition Place. The club has won a Calder Cup and has consistently ranked among the AHL\'s better-drawing franchises.</p>'),
        ],
        "sources": [
            ("NHL.com — Toronto Marlies History", "https://www.nhl.com/mapleleafs/news/toronto-marlies-history/c-460110"),
            ("Toronto Marlies — Marlies History", "https://www.marlies.ca/pages/marlies-history"),
        ],
        "related_words": [],
    },
    {
        "slug": "canada-cup-1976",
        "title": "The 1976 Canada Cup: Bobby Orr's Last Great Stage",
        "kicker": "The first best-on-best hockey tournament, with pivotal games at Maple Leaf Gardens",
        "h1": "The 1976 Canada Cup",
        "dek": "The first tournament to put NHL professionals against the Soviets and Europe's best crowned Canada champion — with the final's opening game at Maple Leaf Gardens, and Bobby Orr playing what proved to be his last great hockey.",
        "meta_desc": "The 1976 Canada Cup: the first best-on-best international hockey tournament, its games at Maple Leaf Gardens, and Bobby Orr's tournament MVP performance.",
        "keywords": "1976 Canada Cup history, Bobby Orr 1976, Maple Leaf Gardens Canada Cup",
        "hero_img": "Maple_Leaf_Gardens_-_50_Carlton_Street,_Toronto,_ON_M5B_1J2,_Canada.jpg",
        "hero_alt": "Exterior of Maple Leaf Gardens, host venue for the 1976 Canada Cup final",
        "hero_credit": "Maple Leaf Gardens, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>The 1976 Canada Cup, held September 2–15, 1976, was the first best-on-best international hockey tournament to include NHL professionals alongside the top players from Europe and the Soviet Union. Six national teams competed in a round-robin format across host cities including Toronto, with the top two finishers advancing to a best-of-three final.</p>'),
            ("Toronto\'s games", '<p><a href="maple-leaf-gardens.html">Maple Leaf Gardens</a> hosted several pivotal matches, including Canada\'s wins over Sweden and the Soviet Union in the round robin. Most significantly, Game 1 of the best-of-three final between Canada and Czechoslovakia was played at Maple Leaf Gardens on September 13, 1976, with Canada winning 6–0 en route to sweeping the two-game final.</p>'),
            ("Bobby Orr\'s last great stage", '<p>Team Canada finished atop the standings and won the tournament outright. Bobby Orr, playing what would prove to be effectively his final competitive hockey given the knee injuries that soon ended his career, was named tournament MVP — giving the 1976 Canada Cup a bittersweet historical weight as one of the last showcases of Orr near his peak. The tournament\'s success led directly to four more Canada Cup events, establishing the format that eventually evolved into the modern World Cup of Hockey.</p>'),
        ],
        "sources": [
            ("NHL.com — 4 Nations Face-Off Reunion Between 1976 Canada Cup Foes", "https://www.nhl.com/news/4-nations-face-off-reunion-between-1976-canada-cup-foes"),
            ("EBSCO Research Starters — Canada Cup of 1976", "https://www.ebsco.com/research-starters/sports-and-leisure/canada-cup-1976"),
        ],
        "related_words": [],
    },
    {
        "slug": "vince-carter-raptors",
        "title": "The Vince Carter Era: \"Vinsanity\" in Toronto",
        "kicker": "The Raptors' first superstar, and their most polarizing trade",
        "h1": "The Vince Carter Era",
        "dek": "Before the 2019 championship, there was Vince Carter — a Rookie of the Year, the greatest Slam Dunk Contest performance ever, and a trade in 2004 that split Raptors fans for a decade.",
        "meta_desc": "The Vince Carter era of the Toronto Raptors, 1998-2004: his Rookie of the Year season, the 2000 Slam Dunk Contest, and the controversial trade that ended his time in Toronto.",
        "keywords": "Vince Carter Raptors history, Vinsanity, Vince Carter trade 2004",
        "hero_img": "Toronto_skyline_(2012).jpg",
        "hero_alt": "The Toronto skyline",
        "hero_credit": "Toronto skyline — Wikimedia Commons, CC BY 2.0",
        "sections": [
            (None, '<p>On June 24, 1998, the Golden State Warriors selected Vince Carter 5th overall in the NBA Draft out of the University of North Carolina, then immediately traded him to the Toronto Raptors in a draft-night swap for fellow North Carolina product Antawn Jamison. Carter made his NBA debut in February 1999 and went on to average 18.3 points per game in his rookie season, winning the NBA Rookie of the Year award and immediately becoming the face of a still-young franchise.</p>'),
            ("\"Vinsanity\" and the 2000 dunk contest", '<p>Carter\'s second season cemented his stardom: he earned his first All-Star selection, averaged 25.7 points per game, and led Toronto to its first playoff appearance in franchise history. The defining moment of the "Vinsanity" era came at NBA All-Star Weekend in February 2000, where Carter — competing against his cousin and Raptors teammate Tracy McGrady — won the Slam Dunk Contest with a performance widely regarded as the greatest in the event\'s history, including a 360-degree windmill dunk and an off-the-bounce, between-the-legs slam never attempted in competition before.</p>'),
            ("A controversial trade", '<p>Carter\'s Toronto tenure soured after the Raptors missed the playoffs in consecutive seasons following his early peak, amid growing public friction between Carter and team management. On December 17, 2004, the Raptors traded Carter to the New Jersey Nets. The trade remains one of the most polarizing in Raptors history — simultaneously the end of the franchise\'s first true superstar era and the beginning of a rebuild that eventually led to the <a href="raptors-2019.html">2019 championship</a>.</p>'),
        ],
        "sources": [
            ("Naismith Memorial Basketball Hall of Fame — Vince Carter", "https://www.hoophall.com/hall-of-famers/vince-carter"),
            ("Global News — A Timeline of Carter's History With Raptors", "https://globalnews.ca/news/10779305/a-timeline-of-carters-history-with-raptors/"),
        ],
        "related_words": [],
    },
    {
        "slug": "tiff-festival-history",
        "title": "TIFF: From \"Festival of Festivals\" to the World's Biggest Public Film Festival",
        "kicker": "127 films from 30 countries in 1976, over 700,000 attendees now",
        "h1": "TIFF: The Toronto International Film Festival",
        "dek": "Founded to fix what its creators saw as the cold, exclusive treatment festival guests got elsewhere, TIFF let ordinary moviegoers buy tickets alongside press and industry — and became one of the world's most prominent film festivals.",
        "meta_desc": "The history of the Toronto International Film Festival: its 1976 founding as the Festival of Festivals, its 1994 renaming, and its growth into a global public film festival.",
        "keywords": "TIFF history, Toronto International Film Festival founding, Festival of Festivals",
        "hero_img": "2013_Toronto_Film_Festival_August_29_(9737565818).jpg",
        "hero_alt": "A street-level scene from the 2013 Toronto International Film Festival",
        "hero_credit": "Toronto International Film Festival, 2013 — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>Our <a href="tiff-lightbox.html">TIFF Bell Lightbox guide</a> covers the building. This page is about the festival itself, which launched in 1976 as the "Festival of Festivals," created by Bill Marshall, Dusty Cohl and Henk Van Der Kolk. Their premise was to gather the best films already premiered at other festivals around the world and screen them in one city, while making Toronto unusually hospitable to filmmakers and press.</p>'),
            ("A public festival, not an industry-only one", '<p>The inaugural edition ran October 18–24, 1976, showing 127 films from 30 countries, drawing about 35,000 filmgoers. The festival was officially renamed the Toronto International Film Festival in 1994, reflecting its shift from a festival-of-festivals showcase model to a first-run launchpad for new films. TIFF built its reputation as a publicly attended festival — unlike industry-only events such as Cannes — letting ordinary moviegoers buy tickets alongside press and industry.</p>'),
            ("An Oscar-season bellwether", '<p>TIFF\'s People\'s Choice Award became closely watched as an informal Oscar-season bellwether, since many past winners went on to Best Picture nominations or wins. By the 2020s, TIFF was screening in the range of 200 to 300-plus films from roughly 70 to 80 countries over about ten days each September, with recent editions drawing more than 700,000 attendees.</p>'),
        ],
        "sources": [
            ("The Canadian Encyclopedia — Toronto International Film Festival", "https://www.thecanadianencyclopedia.ca/en/article/toronto-international-film-festival"),
            ("Encyclopaedia Britannica — Toronto International Film Festival (TIFF)", "https://www.britannica.com/art/Toronto-International-Film-Festival"),
        ],
        "related_words": [],
    },
    {
        "slug": "hot-docs-festival",
        "title": "Hot Docs: North America's Largest Documentary Festival",
        "kicker": "Founded by filmmakers, now with a permanent cinema of its own",
        "h1": "Hot Docs",
        "dek": "What began as a small showcase for Canadian documentary work grew into North America's largest documentary festival — and eventually bought the century-old Bloor Street theatre it calls home.",
        "meta_desc": "The history of Hot Docs, the Canadian International Documentary Festival: its 1993 founding, its growth into North America's largest documentary festival, and its Bloor Street cinema.",
        "keywords": "Hot Docs history, documentary film festival Toronto, Hot Docs Ted Rogers Cinema",
        "hero_img": "Hot_Docs_Ted_Rogers_Cinema.jpg",
        "hero_alt": "Exterior of the Hot Docs Ted Rogers Cinema on Bloor Street West, Toronto",
        "hero_credit": "Hot Docs Ted Rogers Cinema, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>Hot Docs was founded in 1993 by the Documentary Organization of Canada, a national association of independent filmmakers, as a showcase and advocacy platform for Canadian documentary work. Its first full festival ran in February 1994, and in 1996 it became a separately incorporated non-profit with an expanded mandate to support Canadian and international documentary filmmakers. Today it bills itself as the largest documentary festival in North America, presenting 150-plus documentaries annually each spring.</p>'),
            ("A permanent home on Bloor Street", '<p>Beyond the annual festival, Hot Docs operates a year-round documentary cinema in Toronto\'s Annex neighbourhood. The building at 506 Bloor Street West opened in 1913 as the Madison Theatre and cycled through several names over the 20th century before reopening in March 2012, under Hot Docs\' management, as the Bloor Hot Docs Cinema. In June 2016, a gift from the Rogers Foundation let Hot Docs purchase the building outright, and it was renamed the Hot Docs Ted Rogers Cinema — giving the organization a permanent, first-run home for documentaries outside festival season.</p>'),
        ],
        "sources": [
            ("Hot Docs — About", "https://hotdocs.ca/about"),
            ("International Documentary Association — Celebrating 25 Years of Documentary Film at Hot Docs", "https://www.documentary.org/online-feature/celebrating-25-years-documentary-film-hot-docs"),
        ],
        "related_words": [],
    },
    {
        "slug": "luminato-festival",
        "title": "Luminato: A Festival Born From SARS",
        "kicker": "Two civic leaders' response to a battered tourism economy in 2003",
        "h1": "Luminato Festival",
        "dek": "After the 2003 SARS outbreak hurt Toronto's tourism economy and public image, two prominent Torontonians pitched a large-scale 'cultural Olympics' to signal the city was open, creative and globally connected.",
        "meta_desc": "The history of Luminato Festival: its origins as a response to the 2003 SARS outbreak, its 2007 founding, and its growth into a major multidisciplinary arts festival.",
        "keywords": "Luminato Festival history, Toronto arts festival, Luminato founding",
        "hero_img": "Melanie_Fiona_at_Luminato_2010_(4).jpg",
        "hero_alt": "A performance at Luminato Festival, Toronto",
        "hero_credit": "Luminato Festival, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>Luminato was founded in 2007 by Tony Gagliano and the late David Pecaut, two prominent Toronto civic leaders. The idea grew directly out of the <a href="sars-outbreak.html">2003 SARS outbreak</a>, which had battered Toronto\'s tourism economy and public image; Gagliano and Pecaut began discussing a large-scale "cultural Olympics" that could help rebuild the city\'s cultural profile.</p>'),
            ("A decade of growth", '<p>The first festival launched in June 2007 and ran roughly ten days, featuring performers including Rufus Wainwright, Randy Bachman and director John Malkovich, alongside visual-art installations, theatre and opera. Luminato positions itself as a multidisciplinary festival cutting across music, dance, theatre and visual art, and as one of Canada\'s most active commissioning bodies for new work, drawing more than one million cumulative visitors within its first three years.</p>'),
        ],
        "sources": [
            ("Luminato Festival — Our Legacy", "https://www.luminatofestival.com/ourlegacy"),
            ("The Globe and Mail — Tony Gagliano, the Unlikely Messiah Behind Luminato", "https://www.theglobeandmail.com/news/toronto/tony-gagliano-the-unlikely-messiah-behind-luminato/article1211755/"),
        ],
        "related_words": [],
    },
    {
        "slug": "nuit-blanche-toronto",
        "title": "Nuit Blanche Toronto: 425,000 People, One Free Night",
        "kicker": "An all-night contemporary art event that nearly doubled its audience by year two",
        "h1": "Nuit Blanche Toronto",
        "dek": "Toronto's first all-night, free contemporary art event drew an estimated 425,000 people in 2006 — and nearly 800,000 the following year, instantly making it a fixture of the city's cultural calendar.",
        "meta_desc": "The history of Nuit Blanche Toronto: its 2006 founding as an all-night, free contemporary art event, and its growth into one of the city's largest cultural events.",
        "keywords": "Nuit Blanche Toronto history, all-night art festival Toronto",
        "hero_img": "Lite_brite_Toronto_Nuit_Blanche.jpg",
        "hero_alt": "An illuminated public art installation during Nuit Blanche Toronto",
        "hero_credit": "Nuit Blanche Toronto — Wikimedia Commons, CC BY 2.0",
        "sections": [
            (None, '<p>Nuit Blanche Toronto held its inaugural edition on the night of September 30, 2006, as an all-night, free, city-produced celebration of contemporary art staged across downtown streets, public spaces and cultural institutions. It drew an estimated 425,000 people in its very first year.</p>'),
            ("Rapid growth", '<p>Attendance nearly doubled the following year — by its second edition in 2007, roughly 800,000 people took part, signalling that the event had quickly become a fixture of the city\'s cultural calendar. The event is produced by the City of Toronto in partnership with the local arts community, with new curators, themes and artist rosters each year. Since 2006, the event has featured close to 1,800 art installations by approximately 6,350 artists, with organizers estimating it has generated more than $550 million in cumulative economic impact for the city.</p>'),
        ],
        "sources": [
            ("Scotiabank Nuit Blanche — Event History", "https://www.scotiabanknuitblanche.ca/about/event-history.html"),
            ("City of Toronto — Nuit Blanche", "https://www.toronto.ca/explore-enjoy/festivals-events/nuitblanche/"),
        ],
        "related_words": [],
    },
    {
        "slug": "harbourfront-centre",
        "title": "Harbourfront Centre: 40 Hectares of Industrial Land, Reimagined",
        "kicker": "From expropriated rail and shipping land to 4,000 events a year",
        "h1": "Harbourfront Centre",
        "dek": "In 1972, the federal government expropriated 40 hectares of industrial waterfront land and handed it to a Crown corporation with an open-ended mandate: turn it into public cultural space.",
        "meta_desc": "The history of Harbourfront Centre: its 1972 founding on expropriated industrial waterfront land, its 1991 transition to a non-profit, and its role as a major Toronto cultural venue.",
        "keywords": "Harbourfront Centre history, Toronto waterfront redevelopment, Power Plant gallery",
        "hero_img": "Harbourfront,_Toronto,_Ontario_from_CN_Tower_(21652107550).jpg",
        "hero_alt": "Aerial view of Toronto's Harbourfront district and waterfront",
        "hero_credit": "Harbourfront, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>Harbourfront Centre traces to 1972, when the federal government expropriated roughly 40 hectares of industrial <a href="waterfront.html">waterfront</a> land — former rail- and ship-served trucking and warehouse land — and created the Harbourfront Corporation, a Crown corporation, to redevelop it into public cultural and recreational space. Programming began in 1974, with early offerings including literary readings, contemporary dance performances and public craft studios. In 1991, the organization transitioned from a Crown corporation into a non-profit organization, the structure under which it still operates today.</p>'),
            ("A multidisciplinary hub", '<p>Harbourfront Centre today works with more than 450 partner community organizations and hosts more than 4,000 events annually spanning theatre, dance, literature, music, film, visual arts and craft. The site is home to the Toronto International Festival of Authors, one of the world\'s longest-running literary festivals, and the Power Plant Contemporary Art Gallery, housed in a former 1920s waterfront power station on the site.</p>'),
        ],
        "sources": [
            ("The Canadian Encyclopedia — Harbourfront", "https://www.thecanadianencyclopedia.ca/en/article/harbourfront-emc"),
            ("Destination Ontario — Harbourfront Centre", "https://www.destinationontario.com/en-ca/attractions/harbourfront-centre"),
        ],
        "related_words": [],
    },
    {
        "slug": "design-exchange",
        "title": "The Design Exchange: A Museum Inside a 1937 Stock Exchange",
        "kicker": "Canada's most advanced trading floor, later Canada's design museum",
        "h1": "The Design Exchange",
        "dek": "The building at 234 Bay Street was one of the most technologically advanced stock exchanges in the world when it opened in 1937 — and became a design institution once the traders moved out.",
        "meta_desc": "The history of the Design Exchange in Toronto: the 1937 Art Deco Toronto Stock Exchange building, its 1994 conversion into a design museum, and its 2023 reopening as an event venue.",
        "keywords": "Design Exchange history, Toronto Stock Exchange building, 234 Bay Street",
        "hero_img": "New_Toronto_Stock_Exchange_trading_floor.jpg",
        "hero_alt": "Historical photograph of the trading floor inside the 1937 Toronto Stock Exchange building",
        "hero_credit": "Toronto Stock Exchange trading floor — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>The building at 234 Bay Street was completed in 1937 as the second home of the Toronto Stock Exchange, in a streamlined Art Deco style, its facade featuring a sculpted frieze by Canadian artist Charles Comfort. Considered one of the most technologically advanced trading floors in the world at its 1937 opening, the building was formally designated a heritage property by the City of Toronto in 1978. The Toronto Stock Exchange itself vacated the building in 1983 for larger quarters nearby.</p>'),
            ("From trading floor to design museum", '<p>A group calling itself "The Group for the Creation of a Design Centre in Toronto" began organizing in January 1986, incorporated in 1987, and eventually became the Design Exchange, which took over the historic building in 1994 as a design museum and industry organization. The Design Exchange\'s dedicated public design museum component closed in 2019; the organization has continued to run design-focused public programming, including the biennial EDIT design festival, while the historic building was renovated and reopened in April 2023 primarily as an event and exhibition venue.</p>'),
        ],
        "sources": [
            ("Design Exchange — Official Site", "https://designexchangetoronto.com/"),
            ("Canadian Interiors — The End of an Era: The Newly Transformed Design Exchange", "https://www.canadianinteriors.com/2023/10/20/the-end-of-an-era-the-newly-transformed-design-exchange/"),
        ],
        "related_words": [],
    },
    {
        "slug": "gardiner-museum",
        "title": "The Gardiner Museum: A Home-Furnishing Hobby That Became a Museum",
        "kicker": "North America's first museum dedicated exclusively to ceramics",
        "h1": "The Gardiner Museum",
        "dek": "George Gardiner started collecting ceramics in 1976 just to furnish his home. Eight years later, his collection had grown into the first museum in North America devoted exclusively to ceramic art.",
        "meta_desc": "The history of the Gardiner Museum in Toronto: George and Helen Gardiner's ceramics collection, and the 1984 opening of North America's first museum dedicated exclusively to ceramics.",
        "keywords": "Gardiner Museum history, ceramics museum Toronto, George Gardiner collection",
        "hero_img": "Covered_Jar_with_Garden_Design,_c._1660-1690,_Arita,_hard-paste_porcelain_with_overglaze_enamels_-_Gardiner_Museum,_Toronto_-_DSC00442.JPG",
        "hero_alt": "A 17th-century Arita porcelain covered jar with garden design, on display at the Gardiner Museum, Toronto",
        "hero_credit": "Gardiner Museum, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>The Gardiner Museum opened to the public on March 6, 1984, becoming the first museum in North America devoted exclusively to ceramics. It was founded by Toronto financier George R. Gardiner and his wife Helen. George Gardiner began collecting ceramics in 1976, initially simply to furnish his home, but the hobby grew into a serious connoisseurship across several distinct areas: ancient American ceramics, Italian Renaissance maiolica, 17th- and 18th-century English pottery, and 18th-century European porcelain.</p>'),
            ("Independence from the ROM", '<p>The purpose-built museum was constructed in 1983 at 111 Queen\'s Park, on land adjacent to the <a href="rom.html">Royal Ontario Museum</a>. Between 1987 and 1996, the Gardiner Museum was managed directly by the ROM, but a substantial endowment from George Gardiner allowed it to separate and regain full independence. Attendance, membership and program participation reportedly more than doubled in the years following independence, and the museum became established as a significant centre for ceramic art and scholarship in North America.</p>'),
        ],
        "sources": [
            ("Gardiner Museum — Museum History", "https://www.gardinermuseum.on.ca/the-museum/about-the-museum/museum-history/"),
            ("Galleries West — Gardiner Museum", "https://www.gallerieswest.ca/locations/gardiner-museum/"),
        ],
        "related_words": [],
    },
    {
        "slug": "bata-shoe-museum",
        "title": "The Bata Shoe Museum: 4,500 Years of Footwear",
        "kicker": "A private shoe collection that grew into a building shaped like a shoebox",
        "h1": "The Bata Shoe Museum",
        "dek": "Sonja Bata started collecting shoes while travelling for her family's shoe-manufacturing business in the 1940s. Her collection eventually needed its own museum — designed to look, from the outside, like a giant stylized shoebox.",
        "meta_desc": "The history of the Bata Shoe Museum in Toronto: Sonja Bata's decades-long footwear collection, and the 1995 opening of a Raymond Moriyama-designed museum devoted exclusively to shoes.",
        "keywords": "Bata Shoe Museum history, Sonja Bata collection, Raymond Moriyama Bata museum",
        "hero_img": "Keds_basketball_sneakers,_1929_-_Bata_Shoe_Museum_-_DSC00724.JPG",
        "hero_alt": "A pair of 1929 Keds basketball sneakers on display at the Bata Shoe Museum, Toronto",
        "hero_credit": "Bata Shoe Museum, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>The Bata Shoe Museum grew out of a private collection assembled by Sonja Bata, a member of the Bata shoe-manufacturing family, who began collecting footwear from around the world starting in the 1940s while travelling for the family business. In 1979, she established the Bata Shoe Museum Foundation with an endowment aimed at professionally managing the growing collection and eventually creating a dedicated public museum.</p>'),
            ("A building shaped like a shoebox", '<p>That goal was realized in 1995: the museum opened to the public on May 6, 1995, at 327 Bloor Street West. The building was designed by celebrated Canadian architect Raymond Moriyama, and is a well-known piece of Toronto architecture in its own right, with a design widely described as evoking the form of a stylized shoebox. The museum\'s holdings comprise more than 13,000 artifacts spanning over 4,500 years of footwear history — from ancient sandals to Indigenous North American moccasins to 20th-century designer shoes — making it one of only a handful of museums anywhere dedicated exclusively to footwear.</p>'),
        ],
        "sources": [
            ("Bata Shoe Museum — About Us", "https://batashoemuseum.ca/about-us/"),
            ("Bata Shoe Museum — Birth of a Museum", "https://batashoemuseum.ca/wp-content/uploads/BSM-Birth-of-a-Museum.pdf"),
        ],
        "related_words": [],
    },
    {
        "slug": "line-2-bloor-danforth",
        "title": "Line 2: The Subway That Killed Two Streetcar Routes in a Day",
        "kicker": "Opened 1966, doubling the number of stations on the network overnight",
        "h1": "Line 2 (Bloor-Danforth Subway)",
        "dek": "When Line 2 opened in 1966, the TTC discontinued the Bloor and Danforth streetcar routes on the very same day — the largest single cutback to Toronto's streetcar network since the original Yonge subway opened.",
        "meta_desc": "The history of Line 2, Toronto's Bloor-Danforth subway: its 1966 opening, its replacement of the Bloor and Danforth streetcar routes, and its later extensions.",
        "keywords": "Line 2 Bloor Danforth subway history, Toronto subway 1966",
        "hero_img": "TTC_PCC_4659,_a_SUBWAY_DANFORTH_car_at_the_Luttrell_Loop,_Toronto,_ON_on_July_3,_1966_(34182476270).jpg",
        "hero_alt": "A TTC streetcar signed \"SUBWAY DANFORTH\" shortly after Line 2 opened, July 1966",
        "hero_credit": "TTC streetcar, July 1966 — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>Formal planning for a Bloor-Danforth subway accelerated in the late 1950s, following the success of the original Yonge subway, opened in 1954. The line was designed to replace the heavily congested Bloor and Danforth streetcar routes. Construction began in 1962, using mostly cut-and-cover methods, which caused major surface disruption along the corridor for years.</p>'),
            ("Opening day", '<p>The TTC officially opened Line 2 on February 26, 1966, with an initial segment running from Keele Station to Woodbine Station — 12.9 km and 22 stations. This doubled the number of stations on the Toronto subway network at the time, and produced the largest single cutback to the <a href="streetcar-network.html">streetcar network</a> since the Yonge line opened in 1954, since the Bloor and Danforth streetcar routes were discontinued the same day.</p>'),
            ("Extensions", '<p>Westward and eastward extensions were already under construction when the line opened, bringing the subway to Islington Avenue in Etobicoke and Warden Avenue in Scarborough by 1968. Today the line runs from Kipling to Kennedy, one of the two backbone lines of the modern TTC network.</p>'),
        ],
        "sources": [
            ("Transit Toronto — A History of Subways on Bloor and Queen Streets", "https://transittoronto.ca/subway/5104.shtml"),
            ("NOW Toronto — 60 Years of Line 2: Key Moments in Toronto's Bloor-Danforth Subway Line's History", "https://nowtoronto.com/news/key-moments-in-torontos-bloor-danforth-subway-lines-history/"),
        ],
        "related_words": [],
    },
    {
        "slug": "scarborough-rt",
        "title": "The Scarborough RT: An Ontario Technology Showcase That Ran Out of Parts",
        "kicker": "38 years of service, ended by a derailment",
        "h1": "The Scarborough RT",
        "dek": "The provincial government pushed the TTC to adopt an experimental, proprietary rail technology as an export showcase. Decades later, the same lack of adopters that made it a poor export made it nearly impossible to keep running.",
        "meta_desc": "The history of the Scarborough RT (TTC Line 3): its 1985 opening using Ontario-developed ICTS technology, its escalating maintenance costs, and its 2023 closure after a derailment.",
        "keywords": "Scarborough RT history, TTC Line 3, ICTS technology Toronto",
        "hero_img": "Toronto_skyline_(2012).jpg",
        "hero_alt": "The Toronto skyline",
        "hero_credit": "Toronto skyline — Wikimedia Commons, CC BY 2.0",
        "sections": [
            (None, '<p>The Scarborough RT began as a planned streetcar/LRT extension, but the Ontario provincial government — through its Urban Transportation Development Corporation — pushed the TTC to instead adopt Intermediate Capacity Transit System (ICTS) technology, using linear-induction-motor vehicles, as a demonstration project for a made-in-Ontario transit export product. The result was TTC Line 3, mechanically related to the trains later exported to Vancouver\'s SkyTrain and the Detroit People Mover.</p>'),
            ("Decline and closure", '<p>Line 3 opened March 24, 1985, offering fast, semi-automated service in its early years. But because the ICTS platform was proprietary and had few other adopters, sourcing replacement parts became increasingly difficult and costly as the fleet aged. In February 2021, TTC staff learned that a third major overhaul of the fleet could cost roughly $522 million with no guarantee of reliability, and concluded closure was the only realistic option. A derailment just south of Lawrence East station on July 24, 2023 forced an immediate, permanent closure ahead of the already-planned retirement date.</p>'),
        ],
        "sources": [
            ("Transit Toronto — The Rise and Fall of the Scarborough RT", "https://transittoronto.ca/subway/5107.shtml"),
            ("Rail Fans Canada — TTC Line 3 (Scarborough RT) (1985–2023)", "https://www.railfans.ca/toronto/content/lines/ttc-line-3"),
        ],
        "related_words": [],
    },
    {
        "slug": "streetcar-network",
        "title": "Toronto's Streetcars: The Network North America Didn't Scrap",
        "kicker": "The continent's largest streetcar operator, mostly by default",
        "h1": "Toronto's Streetcar Network",
        "dek": "By the 1960s, most North American cities had scrapped their streetcars for buses. Toronto didn't — making the TTC the largest streetcar operator on the continent, almost by process of elimination.",
        "meta_desc": "The history of Toronto's streetcar network: why the TTC never abandoned streetcars like most North American cities, the PCC 'Red Rocket' era, and the modern Flexity fleet.",
        "keywords": "Toronto streetcar history, Red Rocket TTC, PCC streetcar Toronto",
        "hero_img": "A_PCC_streetcar_in_Toronto,_in_1980_-a.jpg",
        "hero_alt": "A TTC PCC \"Red Rocket\" streetcar in service on a Toronto street, 1980",
        "hero_credit": "TTC PCC streetcar, 1980 — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>By the 1960s, most U.S. and Canadian cities had scrapped their streetcars in favour of buses. The TTC is frequently cited as the only North American operator to have retained a large-scale, city-wide legacy streetcar network continuously, making it the largest streetcar operator on the continent by default. Toronto streetcars date back to horse-drawn predecessor companies in the 1860s and were electrified in the 1890s; the TTC itself was formed in 1921, consolidating several private operators.</p>'),
            ("The \"Red Rockets\"", '<p>Starting in 1938, the TTC purchased President\'s Conference Committee (PCC) streetcars, which became affectionately known as "Red Rockets" — a nickname Torontonians extended to the streetcar fleet broadly. PCC cars remained in TTC service until 1995, an unusually long service life credited partly to Toronto\'s continued investment in overhauling rather than scrapping the fleet.</p>'),
            ("A modern fleet", '<p>The TTC replaced its aging PCCs with the Canadian Light Rail Vehicle, built in Switzerland; the first arrived in December 1977, entering revenue service in 1979. By the end of 2019, the TTC had received enough Bombardier Flexity Outlook low-floor streetcars to retire the last CLRVs, completing the network\'s most recent full fleet renewal.</p>'),
        ],
        "sources": [
            ("Transit Toronto — Red Rocket Renaissance: The A15 Class PCC Cars", "https://transittoronto.ca/streetcar/4509.shtml"),
            ("CBC News — Now 40 Years Old, the CLRV Streetcar Is a Piece of Toronto History That Almost Never Came to Be", "https://www.cbc.ca/news/canada/toronto/now-40-years-old-the-clrv-streetcar-is-a-piece-of-toronto-history-that-almost-never-came-to-be-1.4460552"),
        ],
        "related_words": [],
    },
    {
        "slug": "eglinton-crosstown",
        "title": "The Eglinton Crosstown: 15 Years From Groundbreaking to Opening",
        "kicker": "A $9.1 billion project that took until 2026 to open",
        "h1": "The Eglinton Crosstown LRT",
        "dek": "Construction began in 2011 on a line originally slated to open in 2020. It finally opened to riders in February 2026, after costs rose well beyond the original budget.",
        "meta_desc": "The history of the Eglinton Crosstown LRT (Line 5): its 2011 construction start, its repeatedly delayed opening, and its eventual 2026 launch connecting Kennedy Station to Mount Dennis.",
        "keywords": "Eglinton Crosstown LRT history, TTC Line 5, Toronto LRT delays",
        "hero_img": "Toronto_skyline_(2012).jpg",
        "hero_alt": "The Toronto skyline",
        "hero_credit": "Toronto skyline — Wikimedia Commons, CC BY 2.0",
        "sections": [
            (None, '<p>Construction on the Eglinton Crosstown began in 2011, at an initial estimated cost of about $9.1 billion for a design-build-finance-maintain contract with the Crosslinx Transit Solutions consortium. The line was originally slated to open in 2020, but the date slipped repeatedly through the 2020s; documents obtained by CBC Toronto in 2022 showed project costs had risen to at least $12.8 billion.</p>'),
            ("A 2026 opening", '<p>The line achieved "substantial completion" on December 5, 2025, following a Revenue Service Demonstration period, at which point full operational control transferred to the TTC. Line 5 Eglinton opened to TTC customers on February 8, 2026. The initial phase runs approximately 19 km from Kennedy Station to Mount Dennis, with 25 stops mixing underground stations and surface-level stops along Eglinton Avenue.</p>'),
        ],
        "sources": [
            ("City of Toronto — Eglinton Crosstown Light Rail Transit", "https://www.toronto.ca/services-payments/streets-parking-transportation/transit-in-toronto/transit-expansion/eglinton-crosstown-and-proposed-extensions/"),
            ("Railway Age — Eglinton Crosstown Substantially Complete", "https://www.railwayage.com/passenger/light-rail/eglinton-crosstown-substantially-complete/"),
        ],
        "related_words": [],
    },
    {
        "slug": "up-express",
        "title": "UP Express: The Airport Train That Had to Cut Its Fare in Half",
        "kicker": "Launched at $27.50 one-way, ridership bottomed out within a year",
        "h1": "UP Express",
        "dek": "The Union Pearson Express opened in 2015 as one of the most expensive airport rail links in North America — and it showed, in ridership numbers that fell for months until Metrolinx slashed the fare in 2016.",
        "meta_desc": "The history of UP Express (Union Pearson Express): its 2015 launch, its early ridership collapse due to high fares, and the 2016 fare cut that turned it around.",
        "keywords": "UP Express history, Union Pearson Express fare cut, Toronto airport train",
        "hero_img": "UP_Express_at_Weston_P6143108.jpg",
        "hero_alt": "A Union Pearson Express train at Weston Station, Toronto",
        "hero_credit": "UP Express at Weston Station, Toronto — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>The Union Pearson Express opened June 6, 2015, timed just ahead of that summer\'s Pan Am Games. It launched as one of the most expensive airport rail links in North America, charging $27.50 one-way in cash. Metrolinx had set a target of 5,000 riders per day within the first year; ridership instead stalled well below that, dropping to an all-time low of about 1,967 average daily riders by January 2016.</p>'),
            ("The fare cut that turned it around", '<p>Facing sustained criticism over pricing, Metrolinx shook up UPX management and, effective March 9, 2016, slashed fares dramatically: the full Union–Pearson trip dropped from $27.50 to $12 cash. Ridership grew substantially afterward, and the line has since become a far more normal part of the city\'s transit options rather than the expensive outlier it launched as.</p>'),
        ],
        "sources": [
            ("Transit Toronto — The Union-Pearson Express", "https://transittoronto.ca/regional/2113.shtml"),
            ("CBC — Union Pearson Express Fare Slashed From $27.50 to $12", "https://amp.cbc.ca/lite/story/1.3459482"),
        ],
        "related_words": [],
    },
    {
        "slug": "bike-share-toronto",
        "title": "Bike Share Toronto: From Near-Collapse to 750-Plus Stations",
        "kicker": "Launched as BIXI, rescued by the city after its operator went broke",
        "h1": "Bike Share Toronto",
        "dek": "Toronto's bike-share system nearly died in 2013 when its Montreal-based operator couldn't repay a city loan. The Toronto Parking Authority took it over instead of shutting it down — and it's grown every year since.",
        "meta_desc": "The history of Bike Share Toronto: its 2011 launch as BIXI Toronto, its 2013 financial near-collapse, and its growth under municipal ownership since 2014.",
        "keywords": "Bike Share Toronto history, BIXI Toronto, Toronto Parking Authority bike share",
        "hero_img": "TD_Bike_Share_Toronto_at_Carlton_and_Sherbourne.JPG",
        "hero_alt": "A Bike Share Toronto docking station with rental bicycles",
        "hero_credit": "Bike Share Toronto, Carlton and Sherbourne — Wikimedia Commons, Creative Commons licensed",
        "sections": [
            (None, '<p>Toronto\'s public bike-share system launched in May 2011 under the BIXI brand, operated by the Montreal-based company behind Montreal\'s BIXI system. It started with 1,000 bicycles at 80 stations concentrated in the downtown core. The system quickly ran into financial trouble: by 2013 it was on the brink of collapse, unable to repay a $3.9 million startup loan from the City of Toronto.</p>'),
            ("Municipal takeover and growth", '<p>In 2014, the Toronto Parking Authority — a municipal agency — took over ownership and management of the system, and it was rebranded Bike Share Toronto as it became a fully public operation. Under Toronto Parking Authority management the network expanded steadily, with a particularly large expansion in 2020 that grew the system to 625 stations and 6,850 bikes. By 2023 it had reached 756 stations and 8,970 bikes, including 1,815 e-bikes.</p>'),
        ],
        "sources": [
            ("City of Toronto — Bike Share Toronto Program Background", "https://www.toronto.ca/legdocs/mmis/2023/pa/bgrd/backgroundfile-240804.pdf"),
        ],
        "related_words": [],
    },
]
...
SLUG_CATEGORIES = {
    ...
    "toronto-arenas-1917": "Sports", "conn-smythe": "Sports", "maple-leaf-gardens": "Sports",
    "toronto-fc-founding": "Sports", "toronto-rock-lacrosse": "Sports", "toronto-marlies": "Sports",
    "canada-cup-1976": "Sports", "vince-carter-raptors": "Sports",
    "tiff-festival-history": "Festivals & Attractions", "hot-docs-festival": "Festivals & Attractions",
    "luminato-festival": "Festivals & Attractions", "nuit-blanche-toronto": "Festivals & Attractions",
    "harbourfront-centre": "Arts, Media & Culture", "design-exchange": "Arts, Media & Culture",
    "gardiner-museum": "Arts, Media & Culture", "bata-shoe-museum": "Arts, Media & Culture",
    "line-2-bloor-danforth": "Transit & Getting Around", "scarborough-rt": "Transit & Getting Around",
    "streetcar-network": "Transit & Getting Around", "eglinton-crosstown": "Transit & Getting Around",
    "up-express": "Transit & Getting Around", "bike-share-toronto": "Transit & Getting Around",
}
