...
(function () {
  ...
  const QUESTIONS = [
    ...
    {
      q: 'The Avro Arrow, one of the world’s most advanced jet interceptors before its 1959 cancellation, was built just outside Toronto in:',
      options: ['Malton', 'Downsview', 'Pickering', 'Etobicoke'],
      correct: 0,
      link: { href: '../guide/avro-arrow.html', label: 'The Avro Arrow' },
    },
    {
      q: 'In 1923, Canada moved beyond its Chinese head tax and:',
      options: [
        'Doubled the tax',
        'Banned Chinese immigration outright',
        'Abolished the tax',
        'Extended the tax to all immigrants',
      ],
      correct: 1,
      link: { href: '../guide/chinese-head-tax.html', label: 'The Chinese Head Tax' },
    },
    {
      q: 'Toronto’s 2003 SARS outbreak was the largest outside which continent?',
      options: ['Asia', 'Europe', 'Africa', 'South America'],
      correct: 0,
      link: { href: '../guide/sars-outbreak.html', label: 'The 2003 SARS Outbreak in Toronto' },
    },
    {
      q: 'Osgoode Hall, home to Ontario’s highest courts since 1832, is known for ornamental gates originally designed to keep out:',
      options: ['Cows', 'Protesters', 'Streetcars', 'Snow'],
      correct: 0,
      link: { href: '../guide/osgoode-hall.html', label: 'Osgoode Hall' },
    },
    {
      q: 'PRESTO, Ontario’s regional transit fare card, started in 2007 as a small pilot program in:',
      options: ['Mississauga', 'Toronto', 'Hamilton', 'Ottawa'],
      correct: 0,
      link: { href: '../guide/presto-card.html', label: 'PRESTO' },
    },
    {
      q: 'Exhibition Place’s 197-acre grounds host BMO Field, the Argonauts, and which massive multicultural festival?',
      options: ['Caribana', 'Taste of Toronto', 'Winterlicious', 'Nuit Blanche'],
      correct: 0,
      link: { href: '../guide/exhibition-place.html', label: 'Exhibition Place' },
    },
    {
      q: 'The Queen’s Plate, North America’s oldest continuously run horse race, held at Woodbine, dates back to:',
      options: ['1860', '1900', '1920', '1867'],
      correct: 0,
      link: { href: '../guide/woodbine-racetrack.html', label: 'Woodbine Racetrack' },
    },
    {
      q: 'The Toronto Argonauts football club’s name comes from its origins as a:',
      options: ['Rowing club', 'Cricket club', 'Military regiment', 'Streetcar company'],
      correct: 0,
      link: { href: '../guide/argonauts-grey-cup.html', label: 'The Toronto Argonauts' },
    },
    {
      q: 'Toronto Hydro’s public-power model traces back to a London, Ontario mayor named:',
      options: ['Adam Beck', 'William Lyon Mackenzie', 'John Graves Simcoe', 'George Brown'],
      correct: 0,
      link: { href: '../guide/toronto-hydro.html', label: 'Toronto Hydro' },
    },
    {
      q: 'The Blue Jays’ name was chosen in 1976 from a contest that drew roughly how many entries?',
      options: ['30,000', '3,000', '300', '130,000'],
      correct: 0,
      link: { href: '../guide/blue-jays-founding.html', label: 'How the Blue Jays Got Their Name' },
    },
    {
      q: 'CBC’s English-language broadcasting headquarters in Toronto was designed by which famous architect?',
      options: ['Philip Johnson', 'Frank Gehry', 'I. M. Pei', 'Daniel Libeskind'],
      correct: 0,
      link: { href: '../guide/cbc-toronto.html', label: 'The Canadian Broadcasting Centre' },
    },
    {
      q: 'In 1990, which Toronto TV station put a video booth on the sidewalk and let anyone speak on camera for a dollar?',
      options: ['Citytv', 'CBC', 'CTV', 'Global'],
      correct: 0,
      link: { href: '../guide/speakers-corner.html', label: 'Speakers Corner' },
    },
    {
      q: 'For decades, the MuchMusic Video Awards turned which Toronto street into an open-air concert every June?',
      options: ['Queen Street West', 'Yonge Street', 'King Street', 'Bloor Street'],
      correct: 0,
      link: { href: '../guide/much-music-awards.html', label: 'The MuchMusic Video Awards' },
    },
    {
      q: 'The Canadian Screen Awards were formed in 2013 by merging the film-focused Genie Awards with:',
      options: ['The Gemini Awards', 'The Emmy Awards', 'The Juno Awards', 'The ACTRA Awards'],
      correct: 0,
      link: { href: '../guide/canadian-screen-awards.html', label: 'The Canadian Screen Awards' },
    },
    {
      q: 'Joseph Atkinson ran the Toronto Star for nearly 50 years and set down progressive values still cited today as the:',
      options: ['Atkinson Principles', 'Star Doctrine', 'Atkinson Code', 'Toronto Charter'],
      correct: 0,
      link: { href: '../guide/toronto-star-legacy.html', label: 'The Atkinson Principles' },
    },
    {
      q: 'TVO, Ontario’s public broadcaster, launched in 1970 with a mandate focused narrowly on:',
      options: ['Education', 'Entertainment', 'News', 'Sports'],
      correct: 0,
      link: { href: '../guide/tvo.html', label: 'TVO' },
    },
    {
      q: 'Toronto researchers James Till and Ernest McCulloch discovered stem cells in 1961 while actually studying:',
      options: [
        'Radiation damage in mice',
        'Insulin production',
        'Cancer treatment in humans',
        'Bone marrow transplants in dogs',
      ],
      correct: 0,
      link: { href: '../guide/stem-cell-discovery.html', label: 'How Stem Cells Were Discovered' },
    },
    {
      q: 'Connaught Labs, founded at U of T in 1914 to make diphtheria antitoxin, later became a major global source of:',
      options: ['Insulin', 'Penicillin', 'Aspirin', 'Morphine'],
      correct: 0,
      link: { href: '../guide/connaught-labs.html', label: 'Connaught Labs' },
    },
    {
      q: 'The world’s first permanent IMAX theatre opened inside the Cinesphere at which Toronto-area site?',
      options: ['Ontario Place', 'CNE grounds', 'Harbourfront', 'The CN Tower'],
      correct: 0,
      link: { href: '../guide/imax-toronto.html', label: 'IMAX’s First Permanent Theatre' },
    },
    {
      q: 'Toronto’s Vector Institute, a dedicated AI research institute, opened in what year?',
      options: ['2017', '2010', '2020', '2005'],
      correct: 0,
      link: { href: '../guide/vector-institute.html', label: 'The Vector Institute' },
    },
    {
      q: 'De Havilland Canada’s Toronto aircraft plant, at its wartime peak, employed roughly how many people?',
      options: ['7,000', '700', '70,000', '17,000'],
      correct: 0,
      link: { href: '../guide/de-havilland-canada.html', label: 'De Havilland Canada' },
    },
    {
      q: 'A Toronto research team identified the gene behind cystic fibrosis in what year?',
      options: ['1989', '1975', '1995', '2001'],
      correct: 0,
      link: { href: '../guide/cystic-fibrosis-gene.html', label: 'The Cystic Fibrosis Gene Discovery' },
    },
  ];
